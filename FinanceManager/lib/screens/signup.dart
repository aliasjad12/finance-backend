    ...
    return Scaffold(
      body: Container(
        ...
        child: Form(
          ...
          child: Column(
            children: [
              Text('Sign up', style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 27)),
              SizedBox(height: 9),
              Text('Create your account', style: TextStyle(color: Colors.black38, fontSize: 20)),
              SizedBox(height: 25),
              _buildTextField(_nameController, 'Username', Icons.person, _validateName),
              SizedBox(height: 25),
